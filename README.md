...
2. The second stage will introduce the more complicated interactions between the users and the OFSS, allowing amending the produced forecasts and prediction intervals and add explanatory variables.
3. On the final stage, the constructor will be created, allowing to deploy the OFSS in any organisation and define which functionality to have.
